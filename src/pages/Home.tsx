...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      image: 'https://images.squarespace-cdn.com/content/v1/673e35f9381a352a4b6c166f/1732133780516-BLVFRGR5OGR7OOT0IRH1/unsplash-image-ekHSHvgr27k.jpg?format=2500w',
    ...
    {
      title: 'Mentoring',
      image: 'https://images.squarespace-cdn.com/content/v1/673e35f9381a352a4b6c166f/687768f9-9fee-4345-8d78-054f39324e10/P1036981.jpg?format=2500w',
    ...
    <div className="bg-brand-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.squarespace-cdn.com/content/v1/673e35f9381a352a4b6c166f/687768f9-9fee-4345-8d78-054f39324e10/P1036981.jpg?format=2500w" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative group">
              <div className="aspect-square rounded-2xl overflow-hidden border border-white/10">
                <img 
                  src="https://images.squarespace-cdn.com/content/v1/673e35f9381a352a4b6c166f/ba1eb24f-d3db-4ab8-b28d-f334cd33c6a8/P1037012.jpg?format=2500w" 
